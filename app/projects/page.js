      ...
      projects: [
        {
          ...
          image: '/iot1.png',
          description: 'IoT project that controls home appliances remotely via web or voice commands.',
        ...
        },
        {
          ...
          image: '/iot2.png',
          description: 'A robot that navigates autonomously using ultrasonic sensors.',
          tech: ['Arduino', 'C++', 'Motor Driver'],
          link: 'https://github.com/yourusername/obstacle-robot',
        },
        {
          id: 9,
          title: 'Smart zebra crossing',
          image: '/iot3.png',
          description: 'Architecture for edge computing and smart data routing in IoT networks.',
